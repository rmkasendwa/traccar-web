export default function ReplayMapPlaceholder({ className = '' }: { className?: string }) {
  return (
    <div
      className={`relative h-full min-h-96 overflow-hidden bg-[#dfe7e2] ${className}`}
      aria-hidden="true"
    >
      ...
      <div className="absolute right-[-8%] top-[56%] h-2.5 w-[68%] rotate-18 rounded-full bg-white/55 shadow-[0_0_0_1px_rgba(148,163,184,.15)]" />
