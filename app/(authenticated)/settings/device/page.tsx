...
import deviceCategories from '@/features/devices/lib/deviceCategories';
import { useTranslation } from '@/providers/localization/LocalizationProvider';
import useDeviceAttributes from '@/features/devices/hooks/useDeviceAttributes';
...
const DevicePage = () => {
  ...
  const handleFileInput = useCatch(async (newFile) => {
    ...
    if (newFile && item?.id) {
      ...
      const { deviceImage: _deviceImage, ...remainingAttributes } = item.attributes || {};
